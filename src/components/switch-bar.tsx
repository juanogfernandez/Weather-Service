    ...
    <div className="my-5 flex w-5/6 justify-end">
      <div className="w-30 flex justify-around">
        ...
        >
          ...
          <span className="text-l mx-1 text-center font-semibold text-[#636262] md:text-xl">
            {scale}
          </span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-l mx-1 text-center font-semibold uppercase text-[#636262] md:text-xl">
            {language}
          </span>
        </button>
      </div>
